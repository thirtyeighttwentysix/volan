...
class ParseErrorTest {
    ...
    fun `recovery reports every mistake in a file rather than only the first`() {
        ...
        codes shouldContain DiagnosticCode.EXPECTED_FIELD_TYPE
        codes shouldContain DiagnosticCode.REPEATED_OPTIONAL_MARKER
        codes shouldContain DiagnosticCode.OPTIONAL_LIST_TYPE
    }
