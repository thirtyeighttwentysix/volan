...
public interface QueryExecutor {
    ...
    public fun <T : @Nullable Any?> findMany(spec: QuerySpec, mapper: RowMapper<T>): List<T>

    /** Reads the first row [spec] selects, or `null` when it selects none. */
    public fun <T : @Nullable Any?> findFirst(spec: QuerySpec, mapper: RowMapper<T>): @Nullable T?
    ...
    public fun aggregate(spec: AggregateSpec): Map<String, @Nullable Any?>
     ...
     */
    public fun <K : @Nullable Any?> groupBy(spec: GroupSpec, mapper: RowMapper<K>): List<GroupRow<K>>

    /** Inserts one row and reads it back. */
    public fun <T : @Nullable Any?> create(spec: CreateSpec, mapper: RowMapper<T>): T
    ...
    public fun <T : @Nullable Any?> update(spec: UpdateSpec, mapper: RowMapper<T>): T
    ...
    public fun <T : @Nullable Any?> upsert(spec: UpsertSpec, mapper: RowMapper<T>): T

    /** Deletes the single row [spec] selects and reads back what was deleted. */
    public fun <T : @Nullable Any?> delete(spec: DeleteSpec, mapper: RowMapper<T>): T
